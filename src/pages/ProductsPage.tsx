...
export function ProductsPage({ 
  ...
  const paginatedProducts = useMemo(() => {
    ...
    // Shuffle products only if not sorting by price or discount
    const productsToDisplay = sortOption === 'newest' 
      ? shuffleArray(filteredAndSortedProducts)
  ...
  return (
    <div className="App">
      ...
      <div className="block sm:hidden flex justify-between items-center bg-white py-2 px-4 mt-2">
        <div className="flex-1 flex justify-center">
          <button
            onClick={() => setIsFilterOpen(true)}
            className="flex items-center justify-center bg-white text-[#333333] py-2 px-4 rounded-sm w-[170px] text-sm border border-[#333333]"
          >
      ...
      <div className="container mx-auto px-4 py-6 flex">
        ...
        <div className="w-full sm:w-3/4 pl-6">
